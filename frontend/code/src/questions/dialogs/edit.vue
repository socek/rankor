<template>
  <b-btn variant="primary" size="small" @click="showModal">
    <icon name="edit"></icon>

    <b-modal id="editQuestionModal" ref="editQuestionModal" title="Create Question" hide-footer :lazy=true>
...
<script>
  ...
  export default {
    ...
    methods: {
      getFormModal () {
        return this.$refs.editQuestionModal
      }
    }
  }
</script>
